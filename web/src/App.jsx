...
export default function App() {
  ...
  async function handleToggle(id, useMock) {
    ...
    await probe(id); // immediately exercise it so stats reflect the new mode
    refresh();
  }
  ...
  return (
    <div className="mx-auto min-h-full max-w-5xl px-4 py-8 text-zinc-100">
      <header className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Musicathon 2026 · partner gateway &amp; live diagnostics
          </p>
        </div>
